                  ...
                  <div className="text-center mb-10">
                    <h2 className="text-3xl font-bold text-gray-900 mb-2">
                      {activeCategory === 'all' ? 'Todos os Produtos' :
                        activeCategory === 'electronics' ? 'Eletrônicos' :
                          activeCategory === 'clothing' ? 'Roupas' :
                            activeCategory === 'home' ? 'Casa & Jardim' :
                              activeCategory === 'accessories' ? 'Acessórios' :
                                activeCategory.charAt(0).toUpperCase() + activeCategory.slice(1)
                      }
                    </h2>
                    <p className="text-gray-600 max-w-2xl mx-auto">
                      {activeCategory === 'all' && 'Veja todos os produtos disponíveis na loja'}
                      {activeCategory === 'electronics' && 'Confira nossa seleção de produtos eletrônicos'}
                      {activeCategory === 'clothing' && 'Encontre as melhores roupas para seu estilo'}
                      {activeCategory === 'home' && 'Itens e acessórios para sua casa e jardim'}
                      {activeCategory === 'accessories' && 'Descubra nossa seleção exclusiva de acessórios'}
                    </p>
                  </div>
