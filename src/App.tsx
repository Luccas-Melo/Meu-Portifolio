...
import { Github, Linkedin, Mail, ExternalLink, Terminal, ChevronRight, Code2, Globe, Database, Palette, Sun, Moon, Home, Briefcase, User, Phone, Menu } from 'lucide-react';
...
function App() {
  ...
  useEffect(() => {
    // Check for system preference and localStorage on first load
  ...
  const projects = [
    {
      ...
      description: "Uma plataforma de e-commerce completa com painel administrativo",
        ...
        <section id="home" className="min-h-screen pt-20 px-6 section-reveal bg-white dark:bg-[#11071F] relative overflow-hidden">
          ...
          <div className="max-w-6xl mx-auto relative" style={{ zIndex: 2 }}>
            ...
            <div className="flex gap-6">
              <a href="https://github.com/luccasdfinformatica" target="_blank" rel="noopener noreferrer" 
                className="p-2 text-zinc-400 hover:text-purple-400 transition-colors">
                <Github size={24} />
              </a>
              <a href="https://linkedin.com/lucas-soares" target="_blank" rel="noopener noreferrer"
                className="p-2 text-zinc-400 hover:text-purple-400 transition-colors">
                <Linkedin size={24} />
              </a>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {projects.map((project, index) => (
                <div key={index} className="project-card rounded-lg overflow-hidden border">
                  <img 
                    src={project.image} 
                    alt={project.title}
