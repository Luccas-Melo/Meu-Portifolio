...
export const products: Product[] = [
  {
    ...
    description: "Experimente um som cristalino com nossos fones de ouvido wireless premium. Possui cancelamento de ruído e 24 horas de bateria.",
  ...
  },
  {
    ...
    price: 749.99,
    description: "Acompanhe sua saúde e exercícios com estilo. Possui monitor cardíaco, GPS e resistência à água.",
  ...
  {
    id: 5,
    name: "Console de Jogos Portátil",
    price: 1000.99,
    originalPrice: 1200.99,
    description: "Console de jogos portátil com tela de 6.2 polegadas e controle removível.",
  ...
  },
  {
    ...
    description: "Estação de carregamento wireless 3 em 1 para celular, relógio e fones de ouvido. Design minimalista e elegante.",
